...
Mtx44::Mtx44(float a00, float a10, float a20, float a30, float a01, float a11, float a21, float a31, float a02, float a12, float a22, float a32, float a03, float a13, float a23, float a33) {
	a[0]  = a00; a[1]  = a10; a[2]  = a20; a[3]  = a30;
	a[4]  = a01; a[5]  = a11; a[6]  = a21; a[7]  = a31;
	a[8]  = a02; a[9]  = a12; a[10] = a22; a[11] = a32;
	a[12] = a03; a[13] = a13; a[14] = a23; a[15] = a33;
}
...
std::ostream& operator<< (std::ostream& os, Mtx44& mat)
{
	os << "[" << mat.a[0]  << "," << mat.a[4]  << "," << mat.a[8]  << "," << mat.a[12] << "]\n";
	os << "[" << mat.a[1]  << "," << mat.a[5]  << "," << mat.a[9]  << "," << mat.a[13] << "]\n";
	os << "[" << mat.a[2]  << "," << mat.a[6]  << "," << mat.a[10] << "," << mat.a[14] << "]\n";
	os << "[" << mat.a[3]  << "," << mat.a[7]  << "," << mat.a[11] << "," << mat.a[15] << "]\n";
	return os;
}